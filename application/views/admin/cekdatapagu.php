    ...
    <div class="card shadow mb-4">
        ...
        <form method="" action="">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="SuratRincianKegiatanHimatif1.pdf">
                </div>
            </div>
            <div class="form-group row">
            ...
            <a href="<?= base_url('/c_admin/Cek_Pagu'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm"> Kembali</a>
                <button type="submit" class="d-none d-lg-inline-block btn btn-sm btn-danger shadow-lg" onclick="return confirm('Alasan Anda Tidak Menyetujui');">Tidak Acc</button>
                <button type="submit" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm" onclick="return confirm('Yakin Ingin Menyetujui Surat Ini');"><i class="fa fa-check"></i> Setuju</button></div>
        </form>
        </div>  
    </div>
</div>