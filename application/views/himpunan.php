          ...
          <div class="col-md-12 text-center" style="margin-bottom: 0px;">
            <div class="kotakb" style="border-style: none; width: 100%;">
              <div class="service-item">
                <img src="<?php echo base_url('assets/img/himatif.jpg')?>" style="width:100px;height:100px; margin: 10px;">
                <hr class="bottom-line">
                <h2 class="service-title pad-bt15" style="font-family: fixed; font-size: 35px">Himpunan Mahasiswa Teknik
                  Informatika</h2>
