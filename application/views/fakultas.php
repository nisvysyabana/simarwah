        ...
        <div class="row" style="margin-bottom: 30px; margin: 100px; margin-top: 50px;">
          <div class="col-md-12 text-center">
            <div style="background-image: url('saintek.jpg');">
              <h2 class="service-title pad-bt15" style="font-family: fixed; font-size: 40px">Fakultas Sains dan
                Teknologi</h2>
          ...
          <div class="col-md-12 text-center" style="margin-bottom: 40px;">
            <div class="service-item">
              <!-- <h3><span>Fakultas</span><span>Sains</span><span>dan Teknologi</span></h3> -->
              <p>Fakultas Sains dan Teknologi terdapat beberapa jurusan, yaitu Fisika, Kimia, Biologi, Matematika,
                Agroteknologi, Teknik Elektro, Teknik Informatika</p>
              </a>
            </div>
          </div>
          ...
          <div class="row" style="margin-bottom: 30px;">
            <div class="col-md-6 col-sm-6 col-xs-12 text-center">
              <div class="service-item">
                <div class="kotakb" style="margin: auto;">
                  <a href="">
                    <img src="<?php echo base_url('assets/img/semafst.jpg')?>" style="width:100px;height:100px; margin: 10px;">
                    <h3><span>SEMA-F</span></h3>
                    <p>Senat Mahasiswa Fakultas Sains dan Teknologi</p>
                  </a>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12 text-center">
              <div class="service-item">
                <div class="kotakb" style="margin: auto;">
                  <a href="">
                    <img src="<?php echo base_url('assets/img/semafst.jpg')?>" style="width:100px;height:100px; margin: 10px;">
                    <h3><span>DEMA - F</span></h3>
                    <p>Dewan Mahasiswa Fakultas Sains dan Teknologi</p>
                  </a>
                </div>
              </div>
            </div>
          ...
          <div class="row" style="margin-bottom: 30px;">
            <div class="col-md-4 col-sm-6 col-xs-12 text-center">
              <div class="service-item">
                <div class="kotakb">
                  <a href="">
                    <img src="<?php echo base_url('assets/img/himasaifi.jpg')?>" style="width:100px;height:100px; margin: auto;">
                    <h3><span>FISIKA</span></h3>
                    <p>Nama Anggota</p>
                  </a>
                </div>
              </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 text-center">
              <div class="service-item">
                <div class="kotakb">
                  <a href="">
                    <img src="<?php echo base_url('assets/img/himasaki.jpg')?>" style="width:100px;height:100px; margin: auto;">
                    <h3><span>KIMIA</span></h3>
                    <p>Nama Anggota</p>
                  </a>
                </div>
              </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 text-center">
              <div class="service-item">
                <div class="kotakb">
                  <a href="">
                    <img src="<?php echo base_url('assets/img/kmhb.jpg')?>" style="width:100px;height:100px; margin: auto;">
                    <h3><span>BIOLOGI</span></h3>
                    <p>Nama Anggota</p>
                  </a>
                </div>
              </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 text-center">
              <div class="service-item">
                <div class="kotakb">
                  <a href="">
                    <img src="<?php echo base_url('assets/img/himatika.jpg')?>" style="width:100px;height:100px; margin: auto;">
                    <h3><span>MATEMATIKA</span></h3>
                    <p>Nama Anggota</p>
                  </a>
                </div>
              </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 text-center">
              <div class="service-item">
                <div class="kotakb">
                  <a href="">
                    <img src="<?php echo base_url('assets/img/himagi.jpeg')?>" style="width:100px;height:100px; margin: auto;">
                    <h3><span style="font-size: 45px; font-family: fantasy;">AGROTEKNOLOGI</span></h3>
                    <p>Nama Anggota</p>
                  </a>
                </div>
              </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 text-center">
              <div class="service-item">
                <div class="kotakb">
                  <a href="">
                    <img src="<?php echo base_url('assets/img/himanitro.jpeg')?>" style="width:100px;height:100px; margin: auto;">
                    <h3><span>TEKNIK ELEKTRO</span></h3>
                    <p>Nama Anggota</p>
                  </a>
                </div>
              </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 text-center">
              <div class="service-item">
                <div class="kotakb">
                  <a href="<?php echo base_url().'c_home/himpunan';?>">
                    <img src="<?php echo base_url('assets/img/himatif.jpg')?>" style="width:100px;height:100px; margin: auto;">
                    <h3><span>TEKNIK INFORMATIKA</span></h3>
                    <p>Nama Anggota</p>
                  </a>
                </div>
              </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
              <img src="assets/img/uinn.png" style="width:150px;height:150px; margin: 10px;">
            </div>
