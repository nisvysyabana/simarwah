...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Menu Pinjam Aula :</h6>
                <a class="collapse-item" href="<?php echo base_url('c_admin/Cek_Surat') ?>">Cek Surat Izin</a>
                <a class="collapse-item" href="<?php echo base_url('c_admin/Data_Pinjam') ?>">Data Peminjaman</a>
            </div>
        </div>
    </li>
    ...
    <!-- Nav Item - Ormawa -->
    <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('c_admin/Data_Ormawa') ?>">
